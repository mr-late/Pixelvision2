"Steam/cached/AccountPage.res"
{
		...
		layout
	{
		...
		place { control=ValidateContactEmailButton,ManageSecurityButton,ChangePasswordButton,ChangeContactEmailButton start=SecurityStatusLabel dir=down height=24 margin-top=25 spacing=9 width=320}
		...
		place { control=ChangeBetaButton start=BetaParticipationLabel dir=right margin-left=0 height=24 width=200}
